...
var App = {
  intro: function(ret){
    ...
    var greetText = 
      "####################################################################################\n"+
      "|\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  |\n"+
      "|\t\tWelcome, I'm " + commandText('Tara') + " - statistical programmer and coffee aficionado. \t\t|\n"+
  ...
  mobile: function(){
    ...
    that.echo("[[g;#B2D100;]Former politico at CGD and DOI]");
    that.echo("tnt2113.github.io/research");
    that.echo();
    that.echo("[[g;#D13F00;]EDUCATION]");
    that.echo("B.A in Econ-Math | Columbia");
    that.echo("tnt2113.github.io/about");
    that.echo();
    that.echo("[[g;#B2D100;]GitHub]");
    that.echo("http://github.com/tnt2113");
    that.echo();
    that.echo("[[g;#D13F00;]Course Notes]");
    that.echo("tnt2113.github.io/courses");
    that.echo();
